<!--
协议文档页，展示服务条款、隐私政策和审核需要的固定文本。

协议内容和登录确认版本要保持一致，本页只负责展示后端文档，不在前端硬编码新的协议版本。

@param: 无；文档内容来自 legal API，返回路径来自路由或浏览器历史。
@return: 渲染协议、隐私政策、版本说明和返回入口。
@raises: 不主动抛业务异常；文档加载失败由页面空态提示承接。
-->
<template>
