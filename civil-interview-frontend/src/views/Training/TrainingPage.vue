<!--
专项训练首页，按题型分类进入练习；题型分类只用于训练选择，不能当作考生能力维度。

这里展示的是综合分析、组织管理、应急应变等题型入口；行政思维、实务落地等能力维度只在评分和复盘里使用。

@param: 无；题型配置来自前端常量，开始练习前再校验登录和权益。
@return: 渲染题型入口、说明文案、权益提示和跳转按钮。
@raises: 不主动抛业务异常；未登录或权益不足由跳转前拦截提示承接。
-->
<template>
