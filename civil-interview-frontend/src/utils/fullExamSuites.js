/**
 * PC 全真模拟套题工具把题库题目按真实套题聚合，地区和考试大类可以分别筛选，默认优先尊重用户考试设置。
 *
 * 全真模拟不应简单随机不限抽题；套题名、年份、地区和时间模式都要尽量从真实题源保留下来，避免山东、江苏等题库被筛掉或串库。
 *
 * @param 无；导出函数接收题目列表、用户筛选和题库接口响应。
 * @return 导出省份归一、套题聚合、筛选选项和全真模拟题组构造函数。
