...
| [复习记录、账号与媒体兼容契约](api/review-and-acceptance.md) | 服务端收藏与低分题、不可变用户归属、旧缓存迁移、人工找回和历史媒体。 |
...
| [2026-09-27 验收反馈修复](testing/acceptance-repair-20260927.md) | 原表行号、跨端修复、测试、库存、构建及体验版实测状态。 |
