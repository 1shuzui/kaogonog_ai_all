<!--
小程序题库管理页给管理员做移动端轻量检索和跳转编辑，批量导入、复杂纠偏仍应优先使用 PC 管理端。
筛选条件沿用真实考试分类口径，避免移动端维护时把江苏事业单位、安徽省考、湖南省考等题源串库。

@param: 无；页面读取管理员身份、题库筛选条件和分页列表。
@return: 渲染题目筛选、列表摘要、新增入口和编辑跳转。
