<!--
小程序题目编辑页用于管理员移动端应急修题，重点是补齐题干、真实题源分类、采分点和关键词，降低评分漂移风险。
分类字段必须遵守真实题源优先：考试体系、地区、系统岗位和题型维度分开保存，不用题型替代岗位分类。

@param: 无；页面从路由 id 判断新增或编辑，并读取题库 store、用户权限和表单内容。
@return: 渲染题目基础字段、高级分类字段、采分点和保存入口。
