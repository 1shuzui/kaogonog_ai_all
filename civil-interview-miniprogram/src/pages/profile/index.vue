<!--
小程序“我的”页，展示账号资料、权益状态、历史/收藏/订单入口、客服反馈和管理员入口。

未登录用户可以看到轻量入口，但点击个人数据和管理功能时才进入登录拦截。这里不直接改权益和订单，
只把用户带到套餐、订单、反馈或管理员页面，保持个人中心简洁。

@param: 无；页面状态来自 user、subscription、billing 和 history store。
@return: 渲染个人资料、权益摘要、功能入口和登录提示。
