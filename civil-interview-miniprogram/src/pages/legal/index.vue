<!--
小程序协议文档页承接服务条款、隐私协议和审核合规说明，用户必须能在主动登录前后都查阅协议内容。
“同意最新版”只在已登录时写入账号状态，未登录浏览协议不能触发手机号、头像或昵称授权。

@param: 无；页面读取协议接口结果、当前 tab 和用户登录状态。
@return: 渲染协议列表、当前协议正文和已登录用户的同意入口。
