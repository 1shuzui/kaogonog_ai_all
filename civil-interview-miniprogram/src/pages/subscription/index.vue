<!--
小程序套餐中心页，展示当前权益、可开通套餐和微信官方虚拟支付入口。

这里不展示审核敏感的技术说明，不把普通支付作为兜底；点击开通前必须确认登录，到账后通过订阅接口刷新权益。
页面只展示权益，不自行推算订单是否支付成功。

@param: 无；套餐、订单和权益状态来自 subscription/billing store 与支付接口。
@return: 渲染套餐列表、当前权益、开通按钮和支付结果提示。
